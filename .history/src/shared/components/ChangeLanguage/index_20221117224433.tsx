...
const ChangeLanguage: any = () => {
  ...
  return (
    <div className={'select-custom'}>
      <Select defaultValue={LANGUAGE[0].value} defaultOpen={true} onChange={changeLanguage}>
        {/* <Option value={LANGUAGE[0].value}><span>VNM</span> <StarIcon /></Option>
        <Option value={LANGUAGE[1].value}><span>ENG</span> <StarIcon /></Option> */}
      </Select>
    </div>
  );
};
